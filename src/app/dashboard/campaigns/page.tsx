...
export default function CampaignsPage() {
  ...
  const definition = (): SegmentDefinition => ({
    ...
    tagIds: splitIds(tagIds),
    labelIds: splitIds(labelIds),
