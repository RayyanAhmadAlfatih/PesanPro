...
type SessionMetrics = {
    ping: string;
    store?: { contacts: number; chats: number; messages: number };
};
                    ...
                    <CardContent className="space-y-4">
                        ...
                        {qrCode && (
                            <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed rounded-lg bg-white relative group">
                                ...
                                <p className="mt-4 text-sm text-gray-500 ">Scan with WhatsApp to connect</p>
                                ...
                                <div className="mt-6 pt-6 border-t w-full">
                                    <div className="flex flex-col items-center gap-3">
                                        ...
                                        {pairingCode && (
                                            <div className="mt-4 p-4 bg-slate-900 rounded-lg w-full max-w-[320px] text-center border-2 border-slate-700 shadow-none relative group/code">
                                                <div className="text-[10px] text-slate-400 uppercase tracking-[0.2em] mb-2 font-semibold">Your Pairing Code</div>
                                                <div
                                                    className="text-3xl font-mono font-bold text-white tracking-[0.3em] flex justify-center cursor-pointer hover:text-[var(--pp-ink)] transition-colors py-2"
                ...
                <Card>
                    ...
                    <CardContent className="space-y-3">
                        <Button
                            ...
                            disabled={session.status === 'CONNECTED' || session.status === 'CONNECTING' || session.status === 'QR_REQUIRED' || session.status === 'PAIRING_REQUIRED'}
                        >
