...
const TYPE_STYLES: Record<string, { icon: LucideIcon; bg: string; border: string; dot: string }> = {
    INFO: { icon: Info, bg: "bg-[var(--pp-teal)] bg-[var(--pp-teal)]", border: "border-l-[var(--pp-teal)]", dot: "bg-[var(--pp-teal)]" },
    ...
    SYSTEM: { icon: Settings, bg: "bg-[var(--pp-blush)] bg-[var(--pp-blush)]", border: "border-l-[var(--pp-blush)]", dot: "bg-[var(--pp-blush)]" },
};
