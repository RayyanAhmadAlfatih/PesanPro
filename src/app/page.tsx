...
export const metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: process.env.NEXT_PUBLIC_APP_URL || "https://wagateway.kingofcoding.my.id",
  },
  twitter: {
            ...
            <div className="flex flex-col items-center text-center space-y-10 max-w-[5xl] mx-auto">
              ...
              <div className="space-y-6">
                ...
                <p className="mx-auto max-w-[42rem] text-muted-foreground text-lg sm:text-xl leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-150">
                  A complete solution for managing WhatsApp sessions, orchestrating smart auto-replies, and integrating via a robust REST API.
                </p>
              </div>
          ...
          <div className="container px-4 md:px-6 relative z-10">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
              ...
              <FeatureCard
                ...
                description="Built on TypeScript with a versioned API, durable queues, and strict input validation."
              />
              <FeatureCard
        ...
        <div className="container px-4 md:px-6 max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} PesanPro. Released under MIT.
            </p>
          </div>
        </div>
      </footer>
