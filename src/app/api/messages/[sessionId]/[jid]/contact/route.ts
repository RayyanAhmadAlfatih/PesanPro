...
import { runWithMessageQuota } from "@/lib/message-quota";
...
export async function POST(
    ...
    try {
        ...
        const sendResult = await runWithMessageQuota({ userId: user.id, sessionId, endpoint: "message.contact" }, () => socket.sendMessage(decodedJid, {
            contacts: {
