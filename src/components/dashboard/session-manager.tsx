...
export function SessionManager({ user }: { user?: AuthUser }) {
                                            ...
                                            <TableCell className="py-3">
                                                <Badge 
                                                    ...
                                                    className={`text-[10px] font-semibold transition-all px-2 py-0.5 shrink-0 inline-flex items-center ${
                                                        session.status === 'CONNECTED' 
                                                            ? 'bg-[var(--pp-mint)] text-[var(--pp-ink)] border border-[var(--pp-line)] hover:bg-[var(--pp-highlight)]' 
                                                ...
                                                >
                                                    <span className={`h-1.5 w-1.5 rounded-full mr-1.5 ${
                                                        session.status === 'CONNECTED' ? 'bg-[var(--pp-mint)] ' : 'bg-slate-400'
                                                    }`} />
                                                    {session.status}
                                                </Badge>
                                            </TableCell>
