...
# ==============================================================================
# 🚀 PesanPro Auto Deployment & Startup Script
# ==============================================================================
...
echo -e "${BLUE}====================================================${NC}"
echo -e "${BLUE}       ⚡ PesanPro PM2 AUTO STARTUP SCRIPT ⚡        ${NC}"
echo -e "${BLUE}====================================================${NC}"
...
echo -e "\n${BLUE}[4/6] Applying database migrations with Prisma...${NC}"
...
node scripts/check-admin-exists.mjs
CHECK_STATUS=$?
...
echo -e "${GREEN}🚀 Starting or reloading PesanPro web and workers...${NC}"
...
echo -e "\n${GREEN}====================================================${NC}"
echo -e "${GREEN}       🎉 PesanPro DEPLOYED SUCCESSFULLY! 🎉         ${NC}"
echo -e "${GREEN}====================================================${NC}"
echo -e "\n${BLUE}Useful PM2 Commands:${NC}"
echo -e "  - View status:           ${YELLOW}pm2 status${NC}"
echo -e "  - View real-time logs:   ${YELLOW}pm2 logs pesanpro${NC}"
echo -e "  - Monitor resources:     ${YELLOW}pm2 monit${NC}"
echo -e "  - Stop all services:     ${YELLOW}pm2 stop pesanpro${NC}"
echo -e "  - Restart all services:  ${YELLOW}pm2 restart pesanpro${NC}"
